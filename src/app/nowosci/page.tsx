...
export default function NowosciPage() {
  const newPlants = [
    {
      name: "Trawa Ozdobna Rozplenica Japońska 'Red Head'",
      price: "32 zł",
      desc: "Jedna z najpiękniejszych traw o ciemnopurpurowych, puszystych kwiatostanach przypominających szczotki.",
      image: "/images/plants/rozplenica_japonska_moudry.jpg"
    },
    {
      name: "Budleja Dawida 'Black Knight' (Motyli Krzew)",
      price: "38 zł",
      desc: "Niezwykle ciemne, fioletowoczarne kwiatostany wabiące setki motyli do Twojego ogrodu przez całe lato.",
      image: "/images/plants/budleja_davida.jpg"
    },
    {
      name: "Sosna Górska (Kosodrzewina) 'Pumilio'",
      price: "48 zł",
      desc: "Niski, gęsty krzew iglasty o powolnym wzroście. Doskonały do ogródków skalnych i do donic.",
      image: "/images/plants/sosna_gorska_pumilio.jpg"
    }
  ];
      ...
      <section className="relative w-full min-h-[50vh] flex items-center overflow-hidden mb-16">
        ...
        <div className="container-custom relative z-10 pt-20">
          ...
          <div className="max-w-[600px]">
            ...
            >
              <Sparkles size={14} /> Świeża Dostawa
            </motion.div>
            <motion.h1
            ...
            >
              Odkryj najnowsze gatunki i odmiany roślin ozdobnych. Dbamy o to, aby regularnie wzbogacać naszą ofertę o zdrowe, dobrze ukorzenione nowości.
            </motion.p>
          </div>
        </div>
      </section>
