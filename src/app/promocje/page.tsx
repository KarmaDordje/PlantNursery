...
import { ArrowLeft, Tag, Percent, Leaf } from "lucide-react";

export default function PromocjePage() {
  const promoPlants = [
    {
      name: "Klon Palmowy 'Atropurpureum'",
      price: "129 zł",
      oldPrice: "169 zł",
      discount: "-24%",
      desc: "Niezwykle dekoracyjne drzewo o purpurowych liściach, idealne jako soliter.",
      image: "/images/plants/real_klon_palmowy_garnet.jpg"
    },
    {
      ...
      oldPrice: "59 zł",
      discount: "-23%",
      desc: "Przepiękne, wielkie kwiatostany zmieniające barwę od seledynowej do kremowobiałej.",
      image: "/images/plants/real_hortensja_bukietowa_limelight.jpg"
    },
    {
      name: "Świerk Srebrzysty 'Glauca Globe'",
      price: "85 zł",
      oldPrice: "110 zł",
      discount: "-22%",
      desc: "Karłowa odmiana o gęstym, kulistym pokroju i intensywnym, niebieskawym zabarwieniu igieł.",
      image: "/images/plants/swierk_klujacy_glauca_globosa.jpg"
    }
  ];
      ...
      <section className="relative w-full min-h-[50vh] flex items-center overflow-hidden mb-16">
        ...
        <div className="container-custom relative z-10 pt-20">
          ...
          <div className="max-w-[600px]">
            ...
            >
              <Percent size={14} /> Oferta Wiosenna
            </motion.div>
            <motion.h1
            ...
            >
              Upiększ swój ogród na wiosnę w wyjątkowych cenach. Przygotowaliśmy dla Ciebie wyselekcjonowane odmiany roślin z rabatem do -30%.
            </motion.p>
          </div>
        </div>
      </section>
          ...
          {promoPlants.map((plant, index) => (
            ...
            >
              <div className="relative h-64 w-full">
                ...
                />
                <div className="absolute top-4 right-4 bg-brand-peach text-brand-dark-green font-bold px-3 py-1 rounded-full text-sm shadow-md">
                  {plant.discount}
                </div>
              </div>
              <div className="p-8">
                ...
                <div className="flex justify-between items-baseline mt-auto">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-brand-sand/40 line-through text-lg">{plant.oldPrice}</span>
                  </div>
                  <Link 
                    href="/katalog"
